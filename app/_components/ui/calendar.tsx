  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn("font-bold select-none text-base sm:text-lg text-white/90", defaultClassNames.caption_label),
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }: any) => {
          if (orientation === "left") {
            return (<ChevronLeft className={cn("size-5", className)} {...props} />);
          }

          if (orientation === "right") {
            return (<ChevronRight className={cn("size-5", className)} {...props} />);
          }
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        isToday && "border-2 border-primary bg-primary/10 text-primary hover:bg-primary/20",
